...
export default function TeacherDashboard() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:3001/api/teacherprofile/profile", config)
      .then((response) => {
      ...
      <div data-theme={isDarkMode ? "dark" : "light"}>
        <div className="studentdashboard-container">
          ...
          <div className="dashboard-rightside">
            <h1>
              Welcome Back, <span>{profile.TeacherName}</span>
            </h1>
            <div className="motivation">
              ...
              <div className="motitext">
                <h2>
                  <span>“</span>The expert in anything was once a beginner.
                  <span>”</span>
                </h2>
                <h3>– Helen Hayes</h3>
              </div>
              ...
              <div className="leftcard">
                ...
                <div className="profiledetails">
                  <div className="profileitem">
                    <strong>Teacher ID:</strong> {profile.TeacherID}
                  </div>
                  <div className="profileitem">
                    <strong>Name:</strong> {profile.TeacherName}
                  </div>
                  <div className="profileitem">
                    <strong>Email:</strong>{" "}
                  ...
                  <div className="profileitem">
                    <strong>Mobile Number:</strong> {profile.TeacherMobileNo}
                  </div>
                </div>
              </div>
